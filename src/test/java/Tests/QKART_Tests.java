...
import Qkart_TestNG.pages.SearchResults;
import Qkart_TestNG.resources.DP;
...
public class QKART_Tests {
	...
	public static void createDriver() throws IOException {
		...
		if (Files.deleteIfExists(
				Paths.get("./RunResults.xlsx"))) {
			System.out.println("Deleted RunResults.xlsx");
		}
		;
	}
	...
	public void TestCase03(String TC3_ProductNameToSearchFor) throws InterruptedException {
		...
		for (WebElement webElement : searchResults) {
			...
			SearchResults resultelement = new SearchResults(webElement);

			// Verify that all results contain the searched text
			String elementText = resultelement.getTitleofResult();
			assertTrue(elementText.toUpperCase().contains(TC3_ProductNameToSearchFor.toUpperCase()),
	...
	public void TestCase04(String TC4_ProductNameToSearchFor) throws InterruptedException {
		...
		for (WebElement webElement : searchResults) {
			SearchResults result = new SearchResults(webElement);
